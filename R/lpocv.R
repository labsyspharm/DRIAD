...
## method - one of {"lgr", "svm"}
lpocv <- function( XY, lPairs, method="lgr" )
{
    if( !(method %in% c("lgr", "svm")) )
        stop( "method must be one of lgr, svm" )
...
#' @param method one of {"lgr", "svm"} for logistics regression and svm respectively
