...
fnX <- synGet( "syn3505720", downloadLocation = destDir )$path
...
fnBT <- synGet( "syn14236139", downloadLocation = destDir )$path
...
fnZ <- synGet( "syn3382527", downloadLocation = destDir )$path
...
fnY <- synGet( "syn3191087", version=6, downloadLocation = destDir )$path
